...
copy.addEventListener("click", () => {
  navigator.clipboard.writeText("pantaabhishek@gmail.com");
...
var messageArr = ["Computer Engineer", "ML enthusiast", "FullStack Developer"];
var textPosition = 0;
var speed = 200;
var messageIndex = 0;
...
typewriter = () => {
  ...
  if (++textPosition > messageArr[messageIndex].length) {
    ...
    messageIndex++;
    // Reset textPosition to 0
    textPosition = 0;
    // If we've cycled through all messages, start again from the beginning
